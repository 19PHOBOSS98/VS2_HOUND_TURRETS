...
local HoundTurretInfiniteAmmo16Barrel = HoundTurretBaseInfiniteAmmo:subclass()


--overridden functions--
function HoundTurretInfiniteAmmo16Barrel:alternateFire(step)
	--[[
		side_index:
		1="front"
		2="left"
...
return HoundTurretInfiniteAmmo16Barrel